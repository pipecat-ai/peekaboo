...
12. **Peekaboo is a showcase of Pipecat core.** Anything the app needs that
    ...
    not built app-side. The window talks RTVI (done: the page is a
    ...
    driven by a Pipecat `UIWorker` (next). Candidates to move upstream from
